...
## Generated on : Fri Nov 13 18:46:51 2020
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Administrator/Desktop
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_ = -DMODEL=untitled -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DUSE_STDPERIPH_DRIVER -DPX4 -DCONFIG_ARCH_BOARD_PX4FMU_V2 -DGIT_VERSION=d3398270e101359de9687c2d077d991c9892f573 -D__DF_NUTTX -D__PX4_NUTTX -DARM_MATH_CM4=1 -D__FPU_PRESENT=1 -D__FPU_USED=1 -DHSE_VALUE=8000000 -DNULL=0 -DEXIT_FAILURE=1 -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLEPRINTF -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
SRCS = $(START_DIR)/untitled_ert_rtw/untitled.c C:/Users/Administrator/Documents/MATLAB/Add-Ons/Toolboxes/PX4PSP/code/src/PX4_TaskControl.c C:/Users/Administrator/Documents/MATLAB/Add-Ons/Toolboxes/PX4PSP/code/src/nuttxinitialize.c
...
OBJS = untitled.o PX4_TaskControl.o nuttxinitialize.o
...
define CALLPX4MK 
	@echo "Making Firmware $2" 
	 E: && cd E:\PX4PSP\PX4Msys2Toolchain && CALL setPX4Env.bat & E:\PX4PSP\PX4Msys2Toolchain\usr\bin\bash.exe -c 'echo Starting PX4 Build;cd $(PX4_BASE);pwd;make $(PX4PSP_CMAKE_CONFIG)'  
...
PX4_TaskControl.o : C:/Users/Administrator/Documents/MATLAB/Add-Ons/Toolboxes/PX4PSP/code/src/PX4_TaskControl.c
	$(CC) $(CFLAGS) -o $@ $<


nuttxinitialize.o : C:/Users/Administrator/Documents/MATLAB/Add-Ons/Toolboxes/PX4PSP/code/src/nuttxinitialize.c
	$(CC) $(CFLAGS) -o $@ $<
